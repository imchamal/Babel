...
const messageIconSvg = `
    <svg class="tavago-message-icon" viewBox="0 0 64 64" aria-hidden="true" focusable="false">
        <path fill-rule="evenodd" clip-rule="evenodd" d="
            M14 59V32C14 23.5 20.2 16 29 13.5C38.6 10.8 49.8 14.3 55 22.6C56.6 25.2 57.2 28 56.5 30.4C61 32.8 63.2 37.4 62.2 42.8C61.1 49.7 55.7 55.4 48.6 57C50.6 51.5 51 45.8 49.5 41.5C48.5 38.6 46.8 36.4 44.3 35.2C39.6 38.4 37.2 43.2 38.1 48.2C38.7 51.4 40.4 55.2 42.2 59H14Z
            M17.5 26.9C12.1 26.4 7.8 23.4 5.5 18.8C11.7 18.9 16.2 20.8 20.2 24.5C19.2 25.2 18.3 26 17.5 26.9Z
            M22.8 19.3C18.5 15.8 16.6 10.9 17.4 5.7C23.1 8.4 26.6 12.5 28.2 17.1C26.3 17.6 24.5 18.3 22.8 19.3Z
            M40.5 24.6C42.2 24.6 43.5 26 43.5 27.8C43.5 29.6 42.2 31 40.5 31C38.8 31 37.5 29.6 37.5 27.8C37.5 26 38.8 24.6 40.5 24.6Z
            M49.5 31.8C45 34 42 38.4 42 43.2C42 48.6 46.1 52.5 51.4 52.6C49.4 49.3 48.2 46.2 48.3 42.7C48.3 39.1 49.8 35.4 53 32.4C51.9 32 50.7 31.8 49.5 31.8Z
            M44.4 41.1C48 42.1 50.5 44.6 51.5 48.1H46.2C42.7 48.1 40.6 46.3 40.6 43.8C40.6 41.8 42 40.6 44.4 41.1Z
        "/>
    </svg>
`;
